                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="username" role="tabpanel" aria-labelledby="username-tab" tabindex="0">
                                <form action="" method="POST" class="col-6 mx-auto mt-5">
                                    <input type="text" name="username" placeholder="Enter username" value="<?php echo $_SESSION['name'] ?>" id="username" class="form-control my-2" required />
                                ...
                                if (isset($_POST['changeUsernamebtn'])) {
                                    ...
                                    $query = "SELECT * FROM hospital  WHERE name = '$setname'";
                                    ...
                                    if ($currentPass != $userPassword) {
                                        ...
                                        $changeUserNameQuery = "UPDATE hospital SET name = '$newusername' WHERE id = '$id'";
                                ...
                                if (isset($_POST['changebtn'])) {
                                    if (isset($_SESSION['name'])) {
                                        ...
                                        if ($current != $currentPass) {
                                            ...
                                            $updateQuery = "update hospital set password = '$new' where id = '$id'";
