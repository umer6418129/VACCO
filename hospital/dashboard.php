                        ...
                        <div class="card-body">
                            <div class="container">
                                <div class="row row-cols-1 row-cols-md-3">
                                    <div>
                                        <div class="card bg-primary shadow mb-3  border-0">
                                            <div class="card-body">
                                    ...
                                    <div>
                                        <div class="card bg-success shadow mb-3   border-0">
                                            <div class="card-body">
                                    ...
                                    <div>
                                        <div class="card bg-primary shadow mb-3   border-0">
                                            <div class="card-body">
                                                <h4 class="text-white">Vaccination Requests:
                                                    <span>
                                                        <?php
                                    ...
                                    <div>
                                        <div class="card bg-success shadow mb-3   border-0">
                                            <div class="card-body">
                                                <h4 class="text-white">Vaccination Appointments:
                                                    <span>
                                                        <?php
                                    ...
                                    <div>
                                        <div class="card bg-primary shadow mb-3   border-0">
                                            <div class="card-body">
                                                <h4 class="text-white">Total Number of Vaccines:
                                                    <span>
                                                        <?php
